function [region1,region2] = measure_intensity(img,x,y,r1,r2,pvalue,smooth)
% [region1,region2] = measure_intensity(img,x,y,r1,r2,pvalue)
%
...
%        intensity > cdfinv(pvalue) 
% is measured.
%
% In the 2nd ring r>r1 & r<r2, the average of
%    cdfinv(pvalue/2) < intensity < cdfinv(1-pvalue/2) 
% is measured.
% 
...
region1 = segment_bright_blob(S, d < r1, img, pvalue);
region2 = segment_background(S, d > r1 & d < r2, img, 0.1);
